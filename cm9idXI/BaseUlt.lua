...
Menu:AddMenu("BaseUlt", "BaseUlt")

if not SupportedChampions[Player.CharName] then
    Menu.BaseUlt:AddLabel("L1", Player.CharName .. " Is Not Supported")
    return
end

Menu.BaseUlt:AddBool("Enabled", "Enabled", true)
...
local OnTick = function()
    if not SpellData[Player.CharName] or not IsReady(_R) or not Menu.BaseUlt.Enabled.Value then
        goto continue
    end
